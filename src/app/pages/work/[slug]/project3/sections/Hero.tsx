        ...
        <div className="flex flex-col-reverse md:flex-row items-center gap-[10px] md:gap-[30px]">
          ...
          <div className="flex flex-col items-start gap-[13px] w-full md:w-[520px] lg:flex-none md:flex-1 min-w-0">
            <p className="text-text-light font-PPMori text-[12px] md:text-[20px] leading-relaxed">
              Streamlined <span className="font-PPMori-SemiBold text-white">healthcare insurance provider portal</span> with <span className="font-PPMori-SemiBold text-white">5 usability fixes</span>, boosting <span className="font-PPMori-SemiBold text-white">task success by 40%.</span> 
            </p>

            <div className="self-stretch leading-[0.9] select-none">
              <h1 className="self-stretch font-PPMori-SemiBold text-[92px] md:text-[116px] text-brand-orange leading-[0.9] min-w-0">
                Portal
              </h1>
              <h1 className="self-stretch font-PPMori-SemiBold text-[90px] md:text-[116px] text-text-light tracking-tight text-right">
                Usability
              </h1>
            </div>
            ...
            <dl className="self-stretch space-y-2 text-[12px] md:text-[16px] text-text-light font-PPMori">
              ...
              <div className="flex gap-2">
                ...
                <dd className="grow">5 UI/UX designers</dd>
              </div>
              <div className="flex gap-2">
          ...
          <div className="min-w-0 w-full md:flex-1 lg:flex-none lg:w-[745px]">
            ...
            ">
              <Image
                ...
                alt={alt}
                fill
                className="object-cover [object-position:50%_50%]"  /* tweak focal point as needed */
                priority
