        ...
        <div className="flex flex-col-reverse md:flex-row items-center gap-[10px] md:gap-[30px]">
          ...
          <div className="flex flex-col items-start gap-[13px] w-full md:w-[520px] lg:flex-none md:flex-1 min-w-0">
            <p className="text-text-light font-PPMori text-[12px] md:text-[20px] leading-relaxed">
              Streamlined parking experience with <span className="font-PPMori-SemiBold text-white">5 key design</span> innovations to <span className="font-PPMori-SemiBold text-white">reduce user stress by 60%.</span> 
            </p>

            <div className="self-stretch leading-[0.9] select-none">
              <h1 className="self-stretch font-PPMori-SemiBold text-[96px] md:text-[116px] text-[#399FD6] leading-[0.9] min-w-0">
                Park
              </h1>
              <h1 className="self-stretch font-PPMori-SemiBold text-[96px] md:text-[116px] text-[#C3E4F4] tracking-tight text-right">
                Away
              </h1>
            </div>
